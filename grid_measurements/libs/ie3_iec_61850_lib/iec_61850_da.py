...
class AnalogueValue(DataAttribute):
    ...
    def __init__(self):
        ...
        self.add_data_attribute("f", None)  # Floating point value
        self.add_data_attribute("i", None)  # Integer value
...
class TimeStamp(DataAttribute):
    ...
    def __init__(self, seconds=0, nanoseconds=0):
        ...
        self.add_data_attribute("seconds", None)  # Seconds since the epoch (UNIX timestamp), int32 (IEC 61850-7-2:2010)
        self.add_data_attribute("second_fractions", None)  # Fractions of a second, int 64 (IEC 61850-7-2:2010)
