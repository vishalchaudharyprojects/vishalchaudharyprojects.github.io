...
class ShuntCompensator(RegulatingCondEq):
	...
	def __init__(self, aVRDelay = 0, grounded = False, maximumSections = 0, nomU = 0.0, normalSections = 0, voltageSensitivity = 0.0, sections = 0.0, SvShuntCompensatorSections = None,  *args, **kw_args):
