...
class ConnectivityNode(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.TP.value, cgmesProfile.EQ_BD.value, ],
						'Terminals': [cgmesProfile.EQ.value,cgmesProfile.EQ_BD.value, ],
						'ConnectivityNodeContainer': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'TopologicalNode': [cgmesProfile.TP.value, ], #TBC
						'boundaryPoint': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value,],
	...
	def __init__(self, Terminals = "list", ConnectivityNodeContainer = None, TopologicalNode = None, boundaryPoint = False,   *args, **kw_args):
