...
#updated as per TC57CIM Profile part 452, CoreEquipment profile ACDC converter
class ACLineSegment(Conductor):
	...
	def __init__(self, bch = 0.0, gch = 0.0, r = 0.0, x = 0.0, b0ch = 0.0, g0ch = 0.0, r0 = 0.0, shortCircuitEndTemperature = 0.0, x0 = 0.0, Clamp = "list", Cut = "list",  *args, **kw_args):
