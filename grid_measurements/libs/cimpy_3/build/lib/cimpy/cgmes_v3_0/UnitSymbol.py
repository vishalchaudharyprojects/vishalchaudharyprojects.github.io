...
class UnitSymbol(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.DL.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						 }
