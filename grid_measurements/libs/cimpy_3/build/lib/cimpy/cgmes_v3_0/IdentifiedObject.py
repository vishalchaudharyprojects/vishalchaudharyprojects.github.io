...
class IdentifiedObject(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'mRID': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'name': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, cgmesProfile.SV.value, ],
						'description': [cgmesProfile.DY.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'DiagramObjects': [cgmesProfile.DL.value, ],
						'energyIdentCodeEic': [cgmesProfile.TP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'shortName': [cgmesProfile.TP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						 }
