...
#updated as per TC57CIM Profile part 452, and sec 14.3
class BaseVoltage(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.TP.value,  cgmesProfile.EQ_BD.value, ],
						...
						'VoltageLevel': [cgmesProfile.EQ.value,cgmesProfile.EQ_BD.value, ],
						'TransformerEnds': [cgmesProfile.EQ.value, ],
						'TopologicalNode': [cgmesProfile.TP.value,  ], #cgmesProfile.TP_BD.value,removed
						 }
