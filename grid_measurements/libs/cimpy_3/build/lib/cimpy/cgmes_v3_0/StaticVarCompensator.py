...
class StaticVarCompensator(RegulatingCondEq):
	...
	def __init__(self, capacitiveRating = 0.0, inductiveRating = 0.0, slope = 0.0, sVCControlMode = None, voltageSetPoint = 0.0, q = 0.0, StaticVarCompensatorDynamics = None, *args, **kw_args):
