...
#updated as per TC57CIM Profile part 452, CoreEquipment profile Main (phase, connducting eq, conn Node)
class Terminal(ACDCTerminal):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'ConductingEquipment': [cgmesProfile.DY.value, cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
