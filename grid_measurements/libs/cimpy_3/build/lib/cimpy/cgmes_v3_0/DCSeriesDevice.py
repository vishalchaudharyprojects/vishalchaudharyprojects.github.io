...
#updated as per TC57CIM Profile standard sec 5.48
class DCSeriesDevice(DCConductingEquipment):
	...
	:ratedUdc: Rated DC device voltage. Converter configuration data used in power flow. Default: 0.0 moved to DCconductinbng equipments
		'''
