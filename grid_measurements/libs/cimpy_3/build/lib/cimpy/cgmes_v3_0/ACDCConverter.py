...
#updated as per TC57CIM Profile part 452, CoreEquipment profile ACDCConverter , 456 core and DC ACDC Converter, 456 state variables
class ACDCConverter(ConductingEquipment):
	...
	def __init__(self, baseS = 0.0, idleLoss = 0.0, maxUdc = 0.0, minUdc = 0.0, numberOfValves = 0, ratedUdc = 0.0, resistiveLoss = 0.0, switchingLoss = 0.0, valveU0 = 0.0, DCTerminals = "list", PccTerminal = None, p = 0.0, q = 0.0, targetPpcc = 0.0, targetUdc = 0.0, idc = 0.0, poleLossP = 0.0, uc = 0.0, udc = 0.0, maxP = 0.0, minP = 0.0, *args, **kw_args):
