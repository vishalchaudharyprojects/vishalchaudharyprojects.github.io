...
class VoltageLevel(EquipmentContainer):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'BaseVoltage': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'Bays': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'Substation': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'highVoltageLimit': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						'lowVoltageLimit': [cgmesProfile.EQ.value, cgmesProfile.EQ_BD.value, ],
						 }
