...
class Resistance(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SSH.value,cgmesProfile.SC.value, ],
						'value': [cgmesProfile.EQ.value, cgmesProfile.SSH.value,cgmesProfile.SC.value, ],
						'unit': [cgmesProfile.EQ.value, cgmesProfile.SSH.value, cgmesProfile.SC.value,],
						'multiplier': [cgmesProfile.EQ.value, cgmesProfile.SSH.value, cgmesProfile.SC.value,],
						 }
