...
#updated as per TC57CIM Profile part 452, CoreEquipment profile Main and ADAC connectivity model
class ACDCTerminal(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SSH.value, cgmesProfile.SV.value, cgmesProfile.DY.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.SC.value, cgmesProfile.EQ_BD.value,],
